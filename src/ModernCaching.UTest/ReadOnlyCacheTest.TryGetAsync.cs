...
namespace ModernCaching.UTest
{
    public class ReadOnlyCacheTest_TryGetAsync
    {
        ...
        {
            ReadOnlyCache<string, string> cache = new(null, null, null!, Timer);
        ...
        public async Task ShouldReturnLocalEntryIfExists()
        {
            ...
            ReadOnlyCache<int, int> cache = new(localCacheMock.Object, distributedCacheMock.Object, null!, Timer);
        ...
        public async Task ShouldReturnRemoteEntryIfNoLocalCache()
        {
            ...
            ReadOnlyCache<int, int> cache = new(null, distributedCacheMock.Object, null!, Timer);
            Assert.AreEqual((true, 10), await cache.TryGetAsync(5));
        }
        ...
        public async Task ShouldReturnNullIfNullWasCachedInRemote()
        {
            ...
            ReadOnlyCache<int, string?> cache = new(localCacheMock.Object, distributedCacheMock.Object, null!, Timer);
