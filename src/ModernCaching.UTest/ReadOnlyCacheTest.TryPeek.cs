...
namespace ModernCaching.UTest
{
    public class ReadOnlyCacheTest_TryPeek
    {
        ...
        public void ShouldReturnLocalEntryIfExists()
        {
            ...
            ReadOnlyCache<int, int> cache = new(localCacheMock.Object, null, null!, Timer, Random);
        ...
        public void ShouldReturnNullIfNullWasCached()
        {
            ...
            ReadOnlyCache<int, object?> cache = new(localCacheMock.Object, null, null!, Timer, Random);
